...
HWTEST_F(HdcCredentialBaseTest, TestCreatePathWithMode_MultiLevelDir, TestSize.Level1)
{
    ...
    ASSERT_TRUE(CreatePathWithMode("./1", MODE));
    ASSERT_TRUE(CreatePathWithMode("./1/2", MODE));
    ASSERT_TRUE(CreatePathWithMode("./1/2/3", MODE));

    // remove directory after test.
    ASSERT_EQ(RemovePath("./1"), 0);
}
...
HWTEST_F(HdcCredentialBaseTest, TestCreatePathWithMode_CreateExistsPath, TestSize.Level1)
{
    ...
    ASSERT_FALSE(CreatePathWithMode("./1", MODE));
