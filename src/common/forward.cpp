...
{
    // CMD_FORWARD_CHECK_RESULT CMD_FORWARD_DATA need Content data
    if ((command == CMD_FORWARD_CHECK_RESULT || command == CMD_FORWARD_DATA) &&
        payloadSize <= DWORD_SERIALIZE_SIZE) {
