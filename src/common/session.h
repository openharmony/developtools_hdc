...
public:
    ...
    static void AddDeletedSessionId(uint32_t sessionId);
    static bool IsSessionDeleted(uint32_t sessionId);
...
private:
    ...
    static std::set<uint32_t> deletedSessionIdSet;
    static std::queue<uint32_t> deletedSessionIdQueue;
    static std::shared_mutex deletedSessionIdRecordMutex;
